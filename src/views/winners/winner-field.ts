...
export function removeWinnerField(id: number): void{
  const row = document.querySelector(`[data-winnerId=${CSS.escape(String(id))}"]`);
  row?.remove();
}